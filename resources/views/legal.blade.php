<?php
/*
    Displays legal content for "Terms of use" link and "Privacy" link
*/
?>
...
<x-app-layout>
    ...
    <div class="story-main">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CoolTech, 1 Cupertino, CA 95014.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to CoolTech, accessible from <a href="www.cooltech.co.za" rel="external nofollow noopener" target="_blank">www.cooltech.co.za</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: office@cooltech.co.za</li>
        </ul>
    </div>
    ...
    <div class="story-main">
        ...
        <p class="lead">Last updated: June 26, 2021</p>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CoolTech.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to CoolTech, accessible from <a href="http://www.cooltech.co.za" rel="external nofollow noopener" target="_blank">www.cooltech.co.za</a></p>
            </li>
            <li>
                <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
            </li>
        ...
        <ul>
            <li>By email: <a href="mailto:popia@cooltech.co.za">popia@cooltech.co.za</a></li>
        </ul>
    </div>
    @endif
